        ...
        auth.createUserWithEmailAndPassword(email,password).addOnCompleteListener(RegisterActivity.this,new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                ...
                if (task.isSuccessful())
                {
                    ...
                    reference=FirebaseDatabase.getInstance().getReference().child("Community_User").child(userId);
                    ...
                    reference.setValue(hashMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            ...
                            {
                                pd.dismiss();
                                Intent intent=new Intent(RegisterActivity.this, CommDashBoardActivity.class);
                                ...
                                pd.dismiss();
                                Toast.makeText(RegisterActivity.this, "Details not saved", Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
