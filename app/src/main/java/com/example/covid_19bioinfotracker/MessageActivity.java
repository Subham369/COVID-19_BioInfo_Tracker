...
import com.example.covid_19bioinfotracker.Adapter.MessageAdapter;
import com.example.covid_19bioinfotracker.Chat_Model.Chat;
import com.example.covid_19bioinfotracker.Chat_Model.UserChat;
import com.example.covid_19bioinfotracker.Frag_Chatting.APIService;
import com.example.covid_19bioinfotracker.Notifications.Client;
import com.example.covid_19bioinfotracker.Notifications.Data;
...
public class MessageActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reference= FirebaseDatabase.getInstance().getReference("UserChat").child(userid);
