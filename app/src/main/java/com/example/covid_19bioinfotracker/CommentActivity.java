...
import com.example.covid_19bioinfotracker.Adapter.CommentAdapter;
import com.example.covid_19bioinfotracker.Fragment.Model.Comments;
...
public class CommentActivity extends AppCompatActivity {
    ...
    {
        DatabaseReference reference= FirebaseDatabase.getInstance().getReference("Community_User").child(firebaseUser.getUid());
